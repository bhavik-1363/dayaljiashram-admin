...
export function EditCommitteeMemberDialog({ member, open, onOpenChange }: EditCommitteeMemberDialogProps) {
  const [isSubmitting, setIsSubmitting] = useState(false)
  const [previewImage, setPreviewImage] = useState<string | null>(member?.photoUrl || null)
  ...
  function onSubmit(values: FormValues) {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Committee member updated successfully",
            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start">
              <div className="relative">
                <Avatar className="h-24 w-24">
                  <AvatarImage src={previewImage || "/placeholder.svg"} alt={member.name} />
